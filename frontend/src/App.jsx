...
return (
  <div className="bg-gray-100 text-gray-900 font-sans flex">
    {/* Sidebar - fixed on the left */}
    <Sidebar user={user} logout={logout} />

    {/* Main dashboard area (scrollable center) */}
    <div className="flex-1 ml-56 mr-72 min-h-screen overflow-y-auto">
      {/* Header */}
    ...
    {/* Fixed Chat Sidebar on the right */}
    <RightChat
      token={token}
